...
<div className="mt-3 flex items-center justify-between px-4 lg:justify-around">
  ...
  {/* Icons */}
  <div className="flex">
    <i><Image src={cart} alt="icon" width={22} height={22} className="mr-2 max-sm:bg-white max-sm:rounded-full" /></i>
    <i><Image src={icon} alt="icon" width={22} height={22} className="max-sm:bg-white max-sm:rounded-full"/></i>
  </div>
</div>
