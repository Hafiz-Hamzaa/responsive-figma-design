    ...
    return(
        <div>
            ...
            <div className="flex gap-2 mt-10 ml-40 flex-wrap max-sm:relative right-20 bottom-6 ">
                <Image src={custom} alt="img" width={410} height={500} className="max-sm:w-[230px]  max-sm:filter max-sm:brightness-0 max-sm:bg-white"/>
                <Image src={custom1} alt="img" width={410} height={500}  className="max-sm:w-[230px]  max-sm:filter max-sm:brightness-0 max-sm:bg-white"/>
                <Image src={custom2} alt="img" width={410} height={500}  className="max-sm:w-[230px]  max-sm:filter max-sm:brightness-0 max-sm:bg-white"/>
            </div>
